...
class EditCodeAgent(object): 
    ...
    def __init__(self, api_key:str, task:TaskSpec,
        ...
        if vision_model == 'qwenllama':
            self.brainstorm_model_name = 'qwen'
            self.code_delta_model_name = 'llama'

        if vision_model == 'phillama':
            self.brainstorm_model_name = 'phi'
            self.code_delta_model_name = 'llama'

        if vision_model == 'minicpmllama':
            self.brainstorm_model_name = 'minicpm'
            self.code_delta_model_name = 'llama'

        if vision_model == 'internllama':
            self.brainstorm_model_name = 'intern'
            self.code_delta_model_name = 'llama'
